...
본 플러그인은 단순한 스니펫이라서 워드프레스의 버전 업데이트에만 대응합니다. 본 플러그인의 버전별 <a href="https://github.com/dgnerlab/" target="_blank">원본은 Github에 그대로 공유</a>됩니다. 커스터마이징을 원하신다면 플러그인 설치보다는 function.php에 직접 적용하시기를 추천드립니다.
